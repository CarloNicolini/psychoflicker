...
def startExperiment():
    try:
        ...
        conditionsBilateral = [
            {'label': 'Bilateral-Right',
             'Side': 'Right',
             'startVal': stairInfo['SpeedBiRight'],
             'method':'2AFC',
            ...
            {'label': 'Bilateral-Left',
             'Side': 'Left',
             'startVal': stairInfo['SpeedBiLeft'],
             'method':'2AFC',
             'stepType':stairInfo['StepType'],
             'stepSizes':stepSizes,
        ...
        conditionsUnilateral = [
            {'label': 'Unilateral-Right',
             'Side': 'Right',
             'startVal': stairInfo['SpeedUniRight'],
             'method':'2AFC',
             'stepType':stairInfo['StepType'],
             'stepSizes':stepSizes,
            ...
            {'label': 'Unilateral-Left', 'Side': 'Left', 'startVal': stairInfo['SpeedUniLeft'],
             'method':'2AFC',
             'stepType':stairInfo['StepType'],
             'stepSizes':stepSizes,
        ...
        for i in range(0, int(expInfo['TrainingTrials'])):
            speedValue = 1.25 * (i + 1)
            trackingTrial(
                win, expInfo, speedValue, conditions[randrange(0, 2)])
